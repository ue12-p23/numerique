...
# %% [markdown]
# 2. importez le fichier de données `iris.csv`  
...
# %% [markdown]
# 3. Affichez les 3 premières lignes de la dataframe
...
# %% [markdown]
# 2. quel est le type des 4 mesures ?

# %% [markdown]
# 3. quel est le type de la colonne `Name` ?  
...
# %% [markdown]
# 4. essayez de mettre les noms en majuscules  
...
# %% [markdown]
# 5. observer la valeur de la colonne `Name` dans la dataframe originale  
...
# %% [markdown]
# 3. utilisez la fonction `pandas.Series.astype`  
...
# %% [markdown]
# 4. comme pour les colonnes de type `str`  
...
#
#    réponse: ce moyen vous permet d'accéder aux codes que `pandas` a attribué aux trois noms d'Iris  
#    `'Iris-setosa'` est `0`  
...
# %% [markdown] tags=["level_intermediate"]
# 0. cherchez cette fonction dans la documentation
...
# %% [markdown] tags=["level_intermediate"]
# 2. convertissez la colonne `Name` dans ce type
...
# %% [markdown] tags=["level_intermediate"]
# 3. assurez-vous que vous pouvez trier la dataframe selon ce type
