...
# %% [markdown] tags=["framed_cell"]
# ````{exercise} création de dataframe à partir de liste Python
#
# 1. créer la liste `Python` de ces animaux, leur vitesse et leur durée de vie
# ```python
...
# ```
#
# 1. créez une `pandas.DataFrame` à partir de la liste précédente  
# en lui passant en colonnes la liste `['names', 'speed' et 'lifespan']`
#
